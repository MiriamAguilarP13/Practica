...
# <b>Comentario del revisor</b> <a class="tocSkip"></a>
#     
# Excelente. Hemos realizado una exploración inicial satisfactoria.
# </div>
...
# <b>Comentario del revisor</b> <a class="tocSkip"></a>
#     
# Buen trabajo. Hay que recordar siempre reiniciar el índice y eliminar el antiguo para no tener problemas de búsqueda más adelante.
# </div>
...
# <b>Comentario del revisor</b> <a class="tocSkip"></a>
#     
# Buena decisión. No sabemos si son realmente duplicados al tener información ausente.
# </div>
...
# <b>Comentario del revisor</b> <a class="tocSkip"></a>
#     
# Excelente trabajo en esta sección, Miriam.
# </div>
...
# <b>Comentario del revisor</b> <a class="tocSkip"></a>
#     
# Excelente. A veces es mejor crear una nueva categoría que eliminar los datos ausentes. Perderíamos mucha información en ese caso.
# </div>
...
# <b>Comentario del revisor</b> <a class="tocSkip"></a>
#     
# Es posible que tengamos un error de traducción. En lugar de sensibles, la palabra sería sensato. Debemos verificar si nuestros datos tienen sentido.
# </div>
...
#     
# Ahora conté los valores únicos con ``count_values()`` y los ordené de menor a mayor con ``sort_index()``, ¿si es a lo que se refiere este punto?
# </div>
# 
...
# <b>Respuesta del estudiante</b> <a class="tocSkip"></a>
#     
# No verifiqué y borré los DataFrame ``hour_of_day_orders`` y ``week_day_orders``, pero ya los volví a definir.
# </div>
# 
...
# <b>Comentario del revisor</b> <a class="tocSkip"></a>
#     
# Buen trabajo. Es posible que este pico en el día 30 se deba a datos censurados: en lugar de reportar el tiempo que se demoran después de los 30 días, el dato se llena con 30.
# </div>
...
# <b>Comentario del revisor</b> <a class="tocSkip"></a>
#     
# Perfecto. Has completado esta tarea satisfactoriamente.
# </div>
...
# <b>Comentario del revisor</b> <a class="tocSkip"></a>
#     
# Correcto. Has construido la respuesta y el gráfico asociado apropiadamente.
# </div>
...
# <b>Comentario del revisor</b> <a class="tocSkip"></a>
#     
# Muy buen trabajo en esta sección, Miriam.
# </div>
...
# <b>Comentario del revisor</b> <a class="tocSkip"></a>
#     
# Muy buen trabajo, Miriam. Nos quedan algunos elementos pendientes por resolver tanto de forma como de fondo par apoder aprobar tu proyecto. He dejado comentarios a lo largo del documento para ello.
# </div>
...
# <b>Comentario del revisor</b> <a class="tocSkip"></a>
#     
# Hola, Miriam. Tenemos un error en la ejecución. Debemos corregirlo antes de proseguir con la revisión.
#     
# </div>
...
# <b>Comentario del revisor</b> <a class="tocSkip"></a>
#     
# Excelente trabajo, Miriam. Todo ha sido corregido y has aprobado un nuevo proyecto. ¡Felicitaciones!
#     
# </div>
